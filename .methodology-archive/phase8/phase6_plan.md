...
- [x] **[ENTRY-CHECK]** Confirm Phase 5 exit (Gate 3 PASS) before proceeding (HR-03 — no phase skips):
...
- [x] **[PREFLIGHT-CI]** Confirm CI wiring unchanged (should be set since P1):
  ...
  > If stale: run `python3 harness_cli.py init-project --phase 6 --project $REPO --force`
...
- [x] Gate 4 PASS (composite ≥ 85, all 12 dims, CRG recon done)
