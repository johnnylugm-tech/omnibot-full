...
def verify_telegram_signature(secret: str, body: bytes, signature: str) -> bool:
...
class PlatformVerifier:
    ...
    def verify(self, platform: Platform, secret: str, body: bytes, signature: str) -> bool:
...
async def verify_signature(request: Request, platform: Platform) -> bytes:
