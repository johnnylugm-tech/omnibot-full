...
#### FR-14: Risk Assessment
- [ ] Review open issues from previous gates for FR-14
- [ ] Check `deferred_fixes.md` for FR-14 entries
- [ ] Confirm no new defects introduced
...
- [ ] **[A-DISPATCH]** Dispatch Agent A:
  ...
  python3 harness_cli.py dispatch --role developer --fr-id FR-14 \
    --prompt "Identify risks → document likelihood/impact → define mitigations for FR-14" --phase 7 --project $REPO
  ```
- [ ] **[B-1]** Agent B (ARCHITECT) for FR-14 — dispatch as **STATELESS** subagent:
  ...
  **Agent B prompt structure** (use this template verbatim):
  ```
  You are ARCHITECT. Your task: review the following risk assessment for FR-14.
  You have NO access to any files — all context is provided below.
...
- [ ] **[B-DISPATCH]** Dispatch Agent B:
  ...
  python3 harness_cli.py dispatch --role reviewer --fr-id FR-14 \
    --prompt "Review FR-14 against SRS + SAD" --phase 7 --project $REPO
  ```
  > AgentSpawner auto-logs to `.methodology/sessions_spawn.log` on dispatch (HR-10).
...
> **Delta-check mode** (P7): skip if FR-14 code unchanged since last Gate 1.
- [ ] **[DELTA-CHECK]** Check if FR code changed since last Gate 1:
  ```bash
...
- [ ] **G1a** Prepare Gate 1 for FR-14:
  ```bash
  python3 harness_cli.py run-gate --gate 1 --phase 7 --fr-id FR-14 --delta
  ```
  Read the evaluation prompt printed above.
...
- [ ] **G1c** Finalize Gate 1 for FR-14:
  ```bash
  python3 harness_cli.py finalize-gate --gate 1 --phase 7 --fr-id FR-14
  ```
  **If FAIL** (any dim below threshold): fix code → repeat G1a→G1b→G1c until PASS.
  **Do NOT proceed to G1d until all dims PASS.**
...
#### FR-15: Risk Assessment
- [ ] Review open issues from previous gates for FR-15
- [ ] Check `deferred_fixes.md` for FR-15 entries
- [ ] Confirm no new defects introduced
...
- [ ] **[A-DISPATCH]** Dispatch Agent A:
  ...
  python3 harness_cli.py dispatch --role developer --fr-id FR-15 \
    --prompt "Identify risks → document likelihood/impact → define mitigations for FR-15" --phase 7 --project $REPO
  ```
- [ ] **[B-1]** Agent B (ARCHITECT) for FR-15 — dispatch as **STATELESS** subagent:
  ...
  **Agent B prompt structure** (use this template verbatim):
  ```
  You are ARCHITECT. Your task: review the following risk assessment for FR-15.
  You have NO access to any files — all context is provided below.
...
- [ ] **[B-DISPATCH]** Dispatch Agent B:
  ...
  python3 harness_cli.py dispatch --role reviewer --fr-id FR-15 \
    --prompt "Review FR-15 against SRS + SAD" --phase 7 --project $REPO
  ```
  > AgentSpawner auto-logs to `.methodology/sessions_spawn.log` on dispatch (HR-10).
...
> **Delta-check mode** (P7): skip if FR-15 code unchanged since last Gate 1.
- [ ] **[DELTA-CHECK]** Check if FR code changed since last Gate 1:
  ```bash
...
- [ ] **G1a** Prepare Gate 1 for FR-15:
  ```bash
  python3 harness_cli.py run-gate --gate 1 --phase 7 --fr-id FR-15 --delta
  ```
  Read the evaluation prompt printed above.
...
- [ ] **G1c** Finalize Gate 1 for FR-15:
  ```bash
  python3 harness_cli.py finalize-gate --gate 1 --phase 7 --fr-id FR-15
  ```
  **If FAIL** (any dim below threshold): fix code → repeat G1a→G1b→G1c until PASS.
  **Do NOT proceed to G1d until all dims PASS.**
...
- [ ] Review open issues from previous gates for FR-16
- [ ] Check `deferred_fixes.md` for FR-16 entries
- [ ] Confirm no new defects introduced
...
- [ ] **[A-DISPATCH]** Dispatch Agent A:
  ...
  python3 harness_cli.py dispatch --role developer --fr-id FR-16 \
    --prompt "Identify risks → document likelihood/impact → define mitigations for FR-16" --phase 7 --project $REPO
  ```
- [ ] **[B-1]** Agent B (ARCHITECT) for FR-16 — dispatch as **STATELESS** subagent:
  ...
  **Agent B prompt structure** (use this template verbatim):
  ```
  You are ARCHITECT. Your task: review the following risk assessment for FR-16.
  You have NO access to any files — all context is provided below.
...
- [ ] **[B-DISPATCH]** Dispatch Agent B:
  ...
  python3 harness_cli.py dispatch --role reviewer --fr-id FR-16 \
    --prompt "Review FR-16 against SRS + SAD" --phase 7 --project $REPO
  ```
  > AgentSpawner auto-logs to `.methodology/sessions_spawn.log` on dispatch (HR-10).
...
> **Delta-check mode** (P7): skip if FR-16 code unchanged since last Gate 1.
- [ ] **[DELTA-CHECK]** Check if FR code changed since last Gate 1:
  ```bash
...
- [ ] **G1a** Prepare Gate 1 for FR-16:
  ```bash
  python3 harness_cli.py run-gate --gate 1 --phase 7 --fr-id FR-16 --delta
  ```
  Read the evaluation prompt printed above.
...
- [ ] **G1c** Finalize Gate 1 for FR-16:
  ```bash
  python3 harness_cli.py finalize-gate --gate 1 --phase 7 --fr-id FR-16
  ```
  **If FAIL** (any dim below threshold): fix code → repeat G1a→G1b→G1c until PASS.
  **Do NOT proceed to G1d until all dims PASS.**
...
#### FR-17: Risk Assessment
- [ ] Review open issues from previous gates for FR-17
- [ ] Check `deferred_fixes.md` for FR-17 entries
- [ ] Confirm no new defects introduced
...
- [ ] **[A-DISPATCH]** Dispatch Agent A:
  ...
  python3 harness_cli.py dispatch --role developer --fr-id FR-17 \
    --prompt "Identify risks → document likelihood/impact → define mitigations for FR-17" --phase 7 --project $REPO
  ```
- [ ] **[B-1]** Agent B (ARCHITECT) for FR-17 — dispatch as **STATELESS** subagent:
  ...
  **Agent B prompt structure** (use this template verbatim):
  ```
  You are ARCHITECT. Your task: review the following risk assessment for FR-17.
  You have NO access to any files — all context is provided below.
...
- [ ] **[B-DISPATCH]** Dispatch Agent B:
  ...
  python3 harness_cli.py dispatch --role reviewer --fr-id FR-17 \
    --prompt "Review FR-17 against SRS + SAD" --phase 7 --project $REPO
  ```
  > AgentSpawner auto-logs to `.methodology/sessions_spawn.log` on dispatch (HR-10).
...
> **Delta-check mode** (P7): skip if FR-17 code unchanged since last Gate 1.
- [ ] **[DELTA-CHECK]** Check if FR code changed since last Gate 1:
  ```bash
...
- [ ] **G1a** Prepare Gate 1 for FR-17:
  ```bash
  python3 harness_cli.py run-gate --gate 1 --phase 7 --fr-id FR-17 --delta
  ```
  Read the evaluation prompt printed above.
...
- [ ] **G1c** Finalize Gate 1 for FR-17:
  ```bash
  python3 harness_cli.py finalize-gate --gate 1 --phase 7 --fr-id FR-17
  ```
  **If FAIL** (any dim below threshold): fix code → repeat G1a→G1b→G1c until PASS.
  **Do NOT proceed to G1d until all dims PASS.**
...
- [ ] Review open issues from previous gates for FR-18
- [ ] Check `deferred_fixes.md` for FR-18 entries
- [ ] Confirm no new defects introduced
...
- [ ] **[A-DISPATCH]** Dispatch Agent A:
  ...
  python3 harness_cli.py dispatch --role developer --fr-id FR-18 \
    --prompt "Identify risks → document likelihood/impact → define mitigations for FR-18" --phase 7 --project $REPO
  ```
- [ ] **[B-1]** Agent B (ARCHITECT) for FR-18 — dispatch as **STATELESS** subagent:
  ...
  **Agent B prompt structure** (use this template verbatim):
  ```
  You are ARCHITECT. Your task: review the following risk assessment for FR-18.
  You have NO access to any files — all context is provided below.
...
- [ ] **[B-DISPATCH]** Dispatch Agent B:
  ...
  python3 harness_cli.py dispatch --role reviewer --fr-id FR-18 \
    --prompt "Review FR-18 against SRS + SAD" --phase 7 --project $REPO
  ```
  > AgentSpawner auto-logs to `.methodology/sessions_spawn.log` on dispatch (HR-10).
...
> **Delta-check mode** (P7): skip if FR-18 code unchanged since last Gate 1.
- [ ] **[DELTA-CHECK]** Check if FR code changed since last Gate 1:
  ```bash
...
- [ ] **G1a** Prepare Gate 1 for FR-18:
  ```bash
  python3 harness_cli.py run-gate --gate 1 --phase 7 --fr-id FR-18 --delta
  ```
  Read the evaluation prompt printed above.
...
- [ ] **G1c** Finalize Gate 1 for FR-18:
  ```bash
  python3 harness_cli.py finalize-gate --gate 1 --phase 7 --fr-id FR-18
  ```
  **If FAIL** (any dim below threshold): fix code → repeat G1a→G1b→G1c until PASS.
  **Do NOT proceed to G1d until all dims PASS.**
...
#### FR-19: Risk Assessment
- [ ] Review open issues from previous gates for FR-19
- [ ] Check `deferred_fixes.md` for FR-19 entries
- [ ] Confirm no new defects introduced
...
- [ ] **[A-DISPATCH]** Dispatch Agent A:
  ...
  python3 harness_cli.py dispatch --role developer --fr-id FR-19 \
    --prompt "Identify risks → document likelihood/impact → define mitigations for FR-19" --phase 7 --project $REPO
  ```
- [ ] **[B-1]** Agent B (ARCHITECT) for FR-19 — dispatch as **STATELESS** subagent:
  ...
  **Agent B prompt structure** (use this template verbatim):
  ```
  You are ARCHITECT. Your task: review the following risk assessment for FR-19.
  You have NO access to any files — all context is provided below.
...
- [ ] **[B-DISPATCH]** Dispatch Agent B:
  ...
  python3 harness_cli.py dispatch --role reviewer --fr-id FR-19 \
    --prompt "Review FR-19 against SRS + SAD" --phase 7 --project $REPO
  ```
  > AgentSpawner auto-logs to `.methodology/sessions_spawn.log` on dispatch (HR-10).
...
> **Delta-check mode** (P7): skip if FR-19 code unchanged since last Gate 1.
- [ ] **[DELTA-CHECK]** Check if FR code changed since last Gate 1:
  ```bash
...
- [ ] **G1a** Prepare Gate 1 for FR-19:
  ```bash
  python3 harness_cli.py run-gate --gate 1 --phase 7 --fr-id FR-19 --delta
  ```
  Read the evaluation prompt printed above.
...
- [ ] **G1c** Finalize Gate 1 for FR-19:
  ```bash
  python3 harness_cli.py finalize-gate --gate 1 --phase 7 --fr-id FR-19
  ```
  **If FAIL** (any dim below threshold): fix code → repeat G1a→G1b→G1c until PASS.
  **Do NOT proceed to G1d until all dims PASS.**
...
- [ ] Review open issues from previous gates for FR-20
- [ ] Check `deferred_fixes.md` for FR-20 entries
- [ ] Confirm no new defects introduced
...
- [ ] **[A-DISPATCH]** Dispatch Agent A:
  ...
  python3 harness_cli.py dispatch --role developer --fr-id FR-20 \
    --prompt "Identify risks → document likelihood/impact → define mitigations for FR-20" --phase 7 --project $REPO
  ```
- [ ] **[B-1]** Agent B (ARCHITECT) for FR-20 — dispatch as **STATELESS** subagent:
  ...
  **Agent B prompt structure** (use this template verbatim):
  ```
  You are ARCHITECT. Your task: review the following risk assessment for FR-20.
  You have NO access to any files — all context is provided below.
...
- [ ] **[B-DISPATCH]** Dispatch Agent B:
  ...
  python3 harness_cli.py dispatch --role reviewer --fr-id FR-20 \
    --prompt "Review FR-20 against SRS + SAD" --phase 7 --project $REPO
  ```
  > AgentSpawner auto-logs to `.methodology/sessions_spawn.log` on dispatch (HR-10).
...
> **Delta-check mode** (P7): skip if FR-20 code unchanged since last Gate 1.
- [ ] **[DELTA-CHECK]** Check if FR code changed since last Gate 1:
  ```bash
...
- [ ] **G1a** Prepare Gate 1 for FR-20:
  ```bash
  python3 harness_cli.py run-gate --gate 1 --phase 7 --fr-id FR-20 --delta
  ```
  Read the evaluation prompt printed above.
...
- [ ] **G1c** Finalize Gate 1 for FR-20:
  ```bash
  python3 harness_cli.py finalize-gate --gate 1 --phase 7 --fr-id FR-20
  ```
  **If FAIL** (any dim below threshold): fix code → repeat G1a→G1b→G1c until PASS.
  **Do NOT proceed to G1d until all dims PASS.**
...
#### FR-21: Risk Assessment
- [ ] Review open issues from previous gates for FR-21
- [ ] Check `deferred_fixes.md` for FR-21 entries
- [ ] Confirm no new defects introduced
...
- [ ] **[A-DISPATCH]** Dispatch Agent A:
  ...
  python3 harness_cli.py dispatch --role developer --fr-id FR-21 \
    --prompt "Identify risks → document likelihood/impact → define mitigations for FR-21" --phase 7 --project $REPO
  ```
- [ ] **[B-1]** Agent B (ARCHITECT) for FR-21 — dispatch as **STATELESS** subagent:
  ...
  **Agent B prompt structure** (use this template verbatim):
  ```
  You are ARCHITECT. Your task: review the following risk assessment for FR-21.
  You have NO access to any files — all context is provided below.
...
- [ ] **[B-DISPATCH]** Dispatch Agent B:
  ...
  python3 harness_cli.py dispatch --role reviewer --fr-id FR-21 \
    --prompt "Review FR-21 against SRS + SAD" --phase 7 --project $REPO
  ```
  > AgentSpawner auto-logs to `.methodology/sessions_spawn.log` on dispatch (HR-10).
...
> **Delta-check mode** (P7): skip if FR-21 code unchanged since last Gate 1.
- [ ] **[DELTA-CHECK]** Check if FR code changed since last Gate 1:
  ```bash
...
- [ ] **G1a** Prepare Gate 1 for FR-21:
  ```bash
  python3 harness_cli.py run-gate --gate 1 --phase 7 --fr-id FR-21 --delta
  ```
  Read the evaluation prompt printed above.
...
- [ ] **G1c** Finalize Gate 1 for FR-21:
  ```bash
  python3 harness_cli.py finalize-gate --gate 1 --phase 7 --fr-id FR-21
  ```
  **If FAIL** (any dim below threshold): fix code → repeat G1a→G1b→G1c until PASS.
  **Do NOT proceed to G1d until all dims PASS.**
...
#### FR-22: Risk Assessment
- [ ] Review open issues from previous gates for FR-22
- [ ] Check `deferred_fixes.md` for FR-22 entries
- [ ] Confirm no new defects introduced
...
- [ ] **[A-DISPATCH]** Dispatch Agent A:
  ...
  python3 harness_cli.py dispatch --role developer --fr-id FR-22 \
    --prompt "Identify risks → document likelihood/impact → define mitigations for FR-22" --phase 7 --project $REPO
  ```
- [ ] **[B-1]** Agent B (ARCHITECT) for FR-22 — dispatch as **STATELESS** subagent:
  ...
  **Agent B prompt structure** (use this template verbatim):
  ```
  You are ARCHITECT. Your task: review the following risk assessment for FR-22.
  You have NO access to any files — all context is provided below.
...
- [ ] **[B-DISPATCH]** Dispatch Agent B:
  ...
  python3 harness_cli.py dispatch --role reviewer --fr-id FR-22 \
    --prompt "Review FR-22 against SRS + SAD" --phase 7 --project $REPO
  ```
  > AgentSpawner auto-logs to `.methodology/sessions_spawn.log` on dispatch (HR-10).
...
> **Delta-check mode** (P7): skip if FR-22 code unchanged since last Gate 1.
- [ ] **[DELTA-CHECK]** Check if FR code changed since last Gate 1:
  ```bash
...
- [ ] **G1a** Prepare Gate 1 for FR-22:
  ```bash
  python3 harness_cli.py run-gate --gate 1 --phase 7 --fr-id FR-22 --delta
  ```
  Read the evaluation prompt printed above.
...
- [ ] **G1c** Finalize Gate 1 for FR-22:
  ```bash
  python3 harness_cli.py finalize-gate --gate 1 --phase 7 --fr-id FR-22
  ```
  **If FAIL** (any dim below threshold): fix code → repeat G1a→G1b→G1c until PASS.
  **Do NOT proceed to G1d until all dims PASS.**
...
#### FR-23: Risk Assessment
- [ ] Review open issues from previous gates for FR-23
- [ ] Check `deferred_fixes.md` for FR-23 entries
- [ ] Confirm no new defects introduced
...
- [ ] **[A-DISPATCH]** Dispatch Agent A:
  ...
  python3 harness_cli.py dispatch --role developer --fr-id FR-23 \
    --prompt "Identify risks → document likelihood/impact → define mitigations for FR-23" --phase 7 --project $REPO
  ```
- [ ] **[B-1]** Agent B (ARCHITECT) for FR-23 — dispatch as **STATELESS** subagent:
  ...
  **Agent B prompt structure** (use this template verbatim):
  ```
  You are ARCHITECT. Your task: review the following risk assessment for FR-23.
  You have NO access to any files — all context is provided below.
...
- [ ] **[B-DISPATCH]** Dispatch Agent B:
  ...
  python3 harness_cli.py dispatch --role reviewer --fr-id FR-23 \
    --prompt "Review FR-23 against SRS + SAD" --phase 7 --project $REPO
  ```
  > AgentSpawner auto-logs to `.methodology/sessions_spawn.log` on dispatch (HR-10).
...
> **Delta-check mode** (P7): skip if FR-23 code unchanged since last Gate 1.
- [ ] **[DELTA-CHECK]** Check if FR code changed since last Gate 1:
  ```bash
...
- [ ] **G1a** Prepare Gate 1 for FR-23:
  ```bash
  python3 harness_cli.py run-gate --gate 1 --phase 7 --fr-id FR-23 --delta
  ```
  Read the evaluation prompt printed above.
...
- [ ] **G1c** Finalize Gate 1 for FR-23:
  ```bash
  python3 harness_cli.py finalize-gate --gate 1 --phase 7 --fr-id FR-23
  ```
  **If FAIL** (any dim below threshold): fix code → repeat G1a→G1b→G1c until PASS.
  **Do NOT proceed to G1d until all dims PASS.**
...
#### FR-24: Risk Assessment
- [ ] Review open issues from previous gates for FR-24
- [ ] Check `deferred_fixes.md` for FR-24 entries
- [ ] Confirm no new defects introduced
...
- [ ] **[A-DISPATCH]** Dispatch Agent A:
  ...
  python3 harness_cli.py dispatch --role developer --fr-id FR-24 \
    --prompt "Identify risks → document likelihood/impact → define mitigations for FR-24" --phase 7 --project $REPO
  ```
- [ ] **[B-1]** Agent B (ARCHITECT) for FR-24 — dispatch as **STATELESS** subagent:
  ...
  **Agent B prompt structure** (use this template verbatim):
  ```
  You are ARCHITECT. Your task: review the following risk assessment for FR-24.
  You have NO access to any files — all context is provided below.
...
- [ ] **[B-DISPATCH]** Dispatch Agent B:
  ...
  python3 harness_cli.py dispatch --role reviewer --fr-id FR-24 \
    --prompt "Review FR-24 against SRS + SAD" --phase 7 --project $REPO
  ```
  > AgentSpawner auto-logs to `.methodology/sessions_spawn.log` on dispatch (HR-10).
...
> **Delta-check mode** (P7): skip if FR-24 code unchanged since last Gate 1.
- [ ] **[DELTA-CHECK]** Check if FR code changed since last Gate 1:
  ```bash
...
- [ ] **G1a** Prepare Gate 1 for FR-24:
  ```bash
  python3 harness_cli.py run-gate --gate 1 --phase 7 --fr-id FR-24 --delta
  ```
  Read the evaluation prompt printed above.
...
- [ ] **G1c** Finalize Gate 1 for FR-24:
  ```bash
  python3 harness_cli.py finalize-gate --gate 1 --phase 7 --fr-id FR-24
  ```
  **If FAIL** (any dim below threshold): fix code → repeat G1a→G1b→G1c until PASS.
  **Do NOT proceed to G1d until all dims PASS.**
